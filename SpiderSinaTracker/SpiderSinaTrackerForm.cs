...
namespace SpiderTracker
{
    public partial class SpiderSinaTrackerForm : Form
    {
        ...
        {
            var names = SinaSpiderService.Repository.GetGroupNames(GatherWebEnum.Sina);
        ...
        void LoadCacheUserList(bool reload)
        {
            ...
            var users = SinaSpiderService.Repository.GetUsers(RunningConfig.Category, keyword, GatherWebEnum.Sina);
