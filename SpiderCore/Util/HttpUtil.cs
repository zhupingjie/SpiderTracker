...
namespace SpiderCore.Util
{
    ...
    {
        public static string GetHttpRequestHtmlResult(string url,  bool zip, RunningConfig runningConfig)
        {
        ...
        public static string GetHttpRequestJsonResult(string url, RunningConfig runningConfig)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            request.Timeout = 10 * 1000;
        ...
        public static Image GetHttpRequestImageResult(string url, RunningConfig runningConfig)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
        ...
        public static bool GetHttpRequestVedioResult(string url, string filePath, RunningConfig runningConfig)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
        ...
        public static bool GetHttpRequestRangeVedioResult(string url, string referer, string filePath, RunningConfig runningConfig)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            request.Timeout = 60 * 1000;
        ...
        public static bool SinaLogin(RunningConfig runningConfig, string userName, string password)
        {
        ...
        public static string PostHttpRequest(string url, string paramData, RunningConfig runningConfig)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Timeout = 10 * 1000;
        ...
        /// <returns></returns>
        public static string[] GetRemoteImageFiles(RunningConfig runningConfig, string bid, string filename, bool thumb)
        {
        ...
        /// <returns></returns>
        public static APIResult UploadRemoteImage(RunningConfig runningConfig, SinaAction upload, FileInfo imgFile)
        {
        ...
        /// <returns></returns>
        public static bool DeleteSinaSourceImage(RunningConfig runningConfig, string bid, string img)
        {
            try
            {
